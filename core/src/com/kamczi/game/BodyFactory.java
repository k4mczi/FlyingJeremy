...
public class BodyFactory {
    ...
    public Body makePlane(float posx, float posy, float width, float height, int material, BodyDef.BodyType bodyType, boolean fixedRotation){
    ...
    public Body makeSensorBody(float posx, float posy, float radius , BodyDef.BodyType bodyType){
        return makeSensorBody(posx,posy,radius,bodyType,false);
    }

    public Body makeSensorBody(float posx, float posy, float radius , BodyDef.BodyType bodyType, boolean fixedRotation){
        // create a definition
        BodyDef boxBodyDef = new BodyDef();
        boxBodyDef.type = bodyType;
        boxBodyDef.position.x = posx;
